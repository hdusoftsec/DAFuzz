    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/zyp/fuzzer/memdbFuzz/tree_mutation/runtime/thirdparty/utfcpp'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/zyp/fuzzer/memdbFuzz/tree_mutation/runtime/thirdparty/utfcpp'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
